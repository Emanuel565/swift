...
> **Monorepo `swift`:** o backend alvo e `enterprise-api` (Nest) e a extensao
> empacotada e `../enterprise-extension`. Nao e necessario o pacote
> `migration-pack/backend-ghost-audio` / `valorantapi` descrito abaixo, salvo se
> fores recompor o prototipo legado a parte.
...
offscreen, contrato do WebSocket e validacoes finais.
...
- `migration-pack/backend-ghost-audio/`
